...
const customMenue = (
  <Menu>
    <Menu.Item key="en">View1</Menu.Item>
    <Menu.Item key="es">View2</Menu.Item>
  </Menu>
);

const DashboardHeader = ({ editMode, setEditMode, onSave, onCancel }) => {
  return (
    <div className="flex justify-between items-start mb-4">
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-4">
          <h2 className="text-xl font-semibold mb-10">Filters</h2>
          <div>
            <Search placeholder="Search" />
            <button className="w-fit px-3 py-1 bg-white border border-gray-300 rounded-xl hover:border-sky-500 hover:text-sky-500 mt-2 flex items-center gap-1">
              <svg
      ...
      <div className="flex items-center gap-2">
        {editMode ? (
          <div className="flex gap-2">
            <Button
              ...
              onClick={onCancel}
              className="px-3 py-1 bg-gray-400 text-white rounded-xl hover:bg-gray-500"
            >
              Cancel
            </Button>
            <Button
              ...
              onClick={onSave}
              className="px-3 py-1 text-white flex items-center gap-1 hover:!bg-[var(--color-blue-400)]"
            >
              Save
            </Button>
          </div>
          ...
          <Button
            ...
            className="px-3 py-1 bg-white-500 text-black border border-gray-300 rounded-xl flex items-center gap-1 hover:border-blue-400 hover:text-blue-400"
          >
            <svg
              width="1em"
              height="1em"
        ...
        <Dropdown overlay={customMenue} trigger={["click"]}>
          <Button
            style={{ borderRadius: 12 }}
            icon={
              <svg
          ...
          >
            Custom View <DownOutlined className="ml-1" />
          </Button>
        </Dropdown>
      </div>
    </div>
